/*
  # Update contact requests table structure

  1. Changes
    - Add region column
    - Add broker_id column with foreign key reference
    - Update status check constraint
    - Add automatic broker assignment
...
-- Update existing records with region
UPDATE contact_requests
SET region = SUBSTRING(postal_code FROM 1 FOR 2)
WHERE region = '';